...
extension UIFont {
    ...
    static func setFont(size: FontSize, weight: FontWeight = .Regular) -> UIFont {
        ...
        case .iPhone4_4S:
            ...
            if size == .Medium { return UIFontMetrics.default.scaledFont(for: UIFont(name: "Lato-\(weight.rawValue)", size: 10)!) }
        ...
        case .iPhones_5_5s_5c_SE:
            ...
            if size == .Medium { return UIFontMetrics.default.scaledFont(for: UIFont(name: "Lato-\(weight.rawValue)", size: 13)!) }
        ...
        case .iPhones_6Plus_6sPlus_7Plus_8Plus:
            ...
            if size == .Medium { return UIFontMetrics.default.scaledFont(for: UIFont(name: "Lato-\(weight.rawValue)", size: 16)!) }
